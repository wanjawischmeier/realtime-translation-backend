...
def get_args() -> Namespace:
    ...
    cli.add_argument("--min-chunk-size", default='1', dest="min_chunk_size", help="Minimum chunk size")
    cli.add_argument("--vac-chunk-size", default='1', dest="vac_chunk_size", help="Vac chunk size")
...
MIN_CHUNK_SIZE: Final[str] = ARGS.min_chunk_size
VAC_CHUNK_SIZE: Final[str] = ARGS.vac_chunk_size # TODO: 1 is significantly larger than the default 0.04, is this fine?
