...
class Room:
    ...
    async def activate(self, source_lang: str, target_langs: dict[str, int]={}, connection_manager: ConnectionManager=None, save_transcript:bool =False, public_transcript: bool=False):
